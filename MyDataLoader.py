...
class MyDataLoader:
    ...
    def load_datasets(self):
        train_ds_plain  = self.DataClass(split='train',  transform=self.plain_transform, download=DOWNLOAD_FLAG)
        val_ds          = self.DataClass(split='val',    transform=self.plain_transform, download=DOWNLOAD_FLAG)
        test_ds         = self.DataClass(split='test',   transform=self.plain_transform, download=DOWNLOAD_FLAG)
